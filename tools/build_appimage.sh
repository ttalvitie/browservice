...
"${QEMU}" \
    ...
    -append "rw root=/dev/disk/by-id/virtio-hd0-part1 init=/bin/bash -- -c \"echo w | fdisk /dev/disk/by-id/virtio-hd0 ; /usr/bin/growpart /dev/disk/by-id/virtio-hd0 1 ; /usr/sbin/resize2fs /dev/disk/by-id/virtio-hd0-part1 ; sed -i s/1/0/g /etc/apt/apt.conf.d/20auto-upgrades ; exec /sbin/init\"" \
