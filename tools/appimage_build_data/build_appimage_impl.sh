...
apt-get install -y wget make g++ pkg-config libxcb1-dev libx11-dev libpoco-dev libjpeg-dev zlib1g-dev libpango1.0-dev libpangoft2-1.0-0 xvfb xauth libatk-bridge2.0-0 libasound2 libgbm1 libxi6 libcups2 libnss3 libxcursor1 libxrandr2 libxcomposite1 libxss1 libxkbcommon0 libgtk-3-0 binutils patchelf cabextract libx11-xcb1 fuse
...
EXPECTED_DEPS="libGL.so.1 libGLX.so.0 libGLdispatch.so.0 libPocoFoundation.so.80 libPocoNet.so.80 libX11.so.6 libXau.so.6 libXcomposite.so.1 libXdamage.so.1 libXdmcp.so.6 libXext.so.6 libXfixes.so.3 libXfont2.so.2 libXi.so.6 libXmuu.so.1 libXrandr.so.2 libXrender.so.1 libasound.so.2 libatk-1.0.so.0 libatk-bridge-2.0.so.0 libatspi.so.0 libaudit.so.1 libavahi-client.so.3 libavahi-common.so.3 libblkid.so.1 libbrotlicommon.so.1 libbrotlidec.so.1 libbsd.so.0 libbz2.so.1.0 libcairo.so.2 libcap-ng.so.0 libcap.so.2 libcom_err.so.2 libcrypto.so.3 libcups.so.2 libdatrie.so.1 libdbus-1.so.3 libdrm.so.2 libexpat.so.1 libffi.so.8 libfontconfig.so.1 libfontenc.so.1 libfreetype.so.6 libfribidi.so.0 libgbm.so.1 libgcc_s.so.1 libgcrypt.so.20 libgio-2.0.so.0 libglib-2.0.so.0 libgmodule-2.0.so.0 libgnutls.so.30 libgobject-2.0.so.0 libgpg-error.so.0 libgraphite2.so.3 libgssapi_krb5.so.2 libharfbuzz.so.0 libhogweed.so.6 libidn2.so.0 libjpeg.so.8 libk5crypto.so.3 libkeyutils.so.1 libkrb5.so.3 libkrb5support.so.0 liblz4.so.1 liblzma.so.5 libmd.so.0 libmount.so.1 libmspack.so.0 libnettle.so.8 libnspr4.so libnss3.so libnssutil3.so libp11-kit.so.0 libpango-1.0.so.0 libpangoft2-1.0.so.0 libpcre.so.3 libpcre2-8.so.0 libpixman-1.so.0 libplc4.so libplds4.so libpng16.so.16 libpsl.so.5 libselinux.so.1 libsmime3.so libsqlite3.so.0 libssl.so.3 libsystemd.so.0 libtasn1.so.6 libthai.so.0 libudev.so.1 libunistring.so.2 libunwind.so.8 libuuid.so.1 libwayland-server.so.0 libxcb-randr.so.0 libxcb-render.so.0 libxcb-shm.so.0 libxcb.so.1 libxkbcommon.so.0 libz.so.1 libzstd.so.1"
